  ...
  <div id="__log-controls__wrapper" class="h-18 w-full flex flex-col select-none gap-2">
    ...
    <div id="__log-controls__second-row" class="h-8 w-full flex flex-nowrap gap-2">
      ...
      >
        ...
        <span id="__log-controls__explorer-label" class="block">
          View in Explorer
        </span>
        <MaterialRipple />
      </button>
      ...
      >
        ...
        <span id="__log-controls__horizontal-scroll-label" class="hidden sm:block">
          Line Breaks
        </span>
        <MaterialRipple />
      </button>
      ...
      >
        ...
        <span id="__log-controls__virtualization-label" class="hidden sm:block">
          Virtualize
        </span>
        <MaterialRipple />
      </button>
