...
export default defineConfigWithVueTs(
  ...
  globalIgnores([
    // Ignore './src-tauri' because it contains Rust code
    "./src-tauri",
    // Ignore '__mocks__' because they contain CommonJS files
    "./src/__mocks__",
    // Ignore 'vite-env.d.ts' because it is generated by vite
    "./src/vite-env.d.ts",
  ]),
